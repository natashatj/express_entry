...
#initial user
User.create email: "n@g.com", password: "123456"
...
LangScoreTier.create(language_test_id: 1, name_score: "Beginner", clb: "4 or 5")
	...
	LangScoreTier.create language_test_id: 3, name_score: "121-150", clb: "4", skill: "reading"

	LangScoreTier.create language_test_id: 3, name_score: "151-180", clb: "5", skill: "reading"

	LangScoreTier.create language_test_id: 3, name_score: "181-206", clb: "6", skill: "reading"
	LangScoreTier.create language_test_id: 3, name_score: "207-232", clb: "7", skill: "reading"

	LangScoreTier.create language_test_id: 3, name_score: "233-247", clb: "8", skill: "reading"

	LangScoreTier.create language_test_id: 3, name_score: "248-262", clb: "9", skill: "reading"

	LangScoreTier.create language_test_id: 3, name_score: "263-277", clb: "10", skill: "reading"

	#writing
	LangScoreTier.create language_test_id: 3, name_score: "181-225", clb: "4", skill: "writing"

	LangScoreTier.create language_test_id: 3, name_score: "226-270", clb: "5", skill: "writing"

	LangScoreTier.create language_test_id: 3, name_score: "271-309", clb: "6", skill: "writing"

	LangScoreTier.create language_test_id: 3, name_score: "310-348", clb: "7", skill: "writing"

	LangScoreTier.create language_test_id: 3, name_score: "349-370", clb: "8", skill: "writing"

	LangScoreTier.create language_test_id: 3, name_score: "371-392", clb: "9", skill: "writing"

	LangScoreTier.create language_test_id: 3, name_score: "393-415", clb: "10", skill: "writing"
	
	#Listening
	LangScoreTier.create language_test_id: 3, name_score: "145-180", clb: "4", skill: "listening"

	LangScoreTier.create language_test_id: 3, name_score: "181-216", clb: "5", skill: "listening"

	LangScoreTier.create language_test_id: 3, name_score: "217-248", clb: "6", skill: "listening"

	LangScoreTier.create language_test_id: 3, name_score: "249-279", clb: "7", skill: "listening"

	LangScoreTier.create language_test_id: 3, name_score: "280-297", clb: "8", skill: "listening"

	LangScoreTier.create language_test_id: 3, name_score: "298-315", clb: "9", skill: "listening"

	LangScoreTier.create language_test_id: 3, name_score: "316-333", clb: "10", skill: "listening"

	#Speaking
	LangScoreTier.create language_test_id: 3, name_score: "181-225", clb: "4", skill: "speaking"

	LangScoreTier.create language_test_id: 3, name_score: "226-270", clb: "5", skill: "speaking"

	LangScoreTier.create language_test_id: 3, name_score: "271-309", clb: "6", skill: "speaking"

	LangScoreTier.create language_test_id: 3, name_score: "310-348", clb: "7", skill: "speaking"

	LangScoreTier.create language_test_id: 3, name_score: "349-370", clb: "8", skill: "speaking"

	LangScoreTier.create language_test_id: 3, name_score: "371-392", clb: "9", skill: "speaking"

	LangScoreTier.create language_test_id: 3, name_score: "393-415", clb: "10", skill: "speaking"
	...
	['speaking', 'writing', 'reading', 'listening'].each do |skill|
		(4..10).to_a.each do |val|
			LangScoreTier.create language_test_id: 2, name_score: val.to_s, clb: val.to_s, skill: skill
		end
	end
